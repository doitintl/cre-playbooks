...
* BASED ON : https://github.com/ioguix/pgsql-bloat-estimation/blob/master/table/table_bloat.sql
   AND https://github.com/ioguix/pgsql-bloat-estimation/blob/master/btree/btree_bloat.sql
   Unioned together and added sort by extra size DESC
 */
SELECT *
FROM (
...
WHERE real_size > 10485760 -- > 10 MB
  AND bloat_pct > 10
-- NOT is_na
